...
export const renderNeofetch = () => [
  createLine('', ''),
  createLine('╔══════════════════════════════════════════════════════════╗', 'out-cyan'),
  createLine('║  <span class="out-bold">neofetch</span> — System Info                                   ║', 'out-cyan'),
  createLine('╚══════════════════════════════════════════════════════════╝', 'out-cyan'),
  createLine('', ''),
  createLine('hostname: <span class="out-bold">jahirul@portfolio</span>', ''),
  createLine('OS: <span class="out-bold">Linux</span>', ''),
  createLine('Kernel: <span class="out-bold">Python 3.11</span>', ''),
  createLine('Shell: <span class="out-bold">bash 5.2</span>', ''),
  createLine('Terminal: <span class="out-bold">portfolio v3.0</span>', ''),
  createLine('Database: <span class="out-bold">PostgreSQL 16</span>', ''),
  createLine('Cache: <span class="out-bold">Redis 7</span>', ''),
  createLine('Framework: <span class="out-bold">FastAPI</span>', ''),
  createLine('Packages: <span class="out-bold">42 (pip)</span>', ''),
  createLine('', ''),
];
